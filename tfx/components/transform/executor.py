...
class Executor(base_executor.BaseExecutor):
  ...
  @beam.typehints.with_input_types(Tuple[bytes, bytes])
  @beam.typehints.with_output_types(pa.RecordBatch)
  def _FromSerializedToArrowRecordBatches(
      pcoll: beam.pvalue.PCollection,
        ...
        if compute_statistics or materialization_format is not None:
          ...
          if (compute_statistics and
            ...
            if not use_tfxio:
              for dataset in analyze_data_list:
                ...
                dataset.standardized = (
                    dataset.serialized
                    | 'FromSerializedToArrowRecordBatches[{}]'.format(infix)
                    >> self._FromSerializedToArrowRecordBatches(schema_proto))
          ...
          for dataset in transform_data_list:
            ...
            dataset.transformed_and_serialized = (
                ...
                >> beam.ParDo(self._EncodeAsExamples(),
          ...
          if compute_statistics:
            ...
            for dataset in transform_data_list:
              ...
              dataset.transformed_and_standardized = (
                  dataset.transformed_and_serialized
                  | 'FromTransformedAndSerializedToArrowRecordBatches[{}]'
                  .format(infix)
                  >> self._FromSerializedToArrowRecordBatches(
